...
export default function Navbar() {
    ...
    return (
        <>
                ...
                <div className="relative bg-white/80 dark:bg-black/80 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-full px-4 sm:px-6 py-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(255,255,255,0.04)] overflow-hidden transition-all duration-300">
                    <div className="flex items-center justify-between relative z-10">
                        ...
                        <Link
                            ...
                            className="flex-shrink-0 relative w-16 h-16 sm:w-20 sm:h-20 transition-opacity hover:opacity-70 duration-200 active:scale-95 overflow-hidden"
            ...
            <div
                className={`sm:hidden fixed bottom-24 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-sm transition-all duration-400 ease-out ${isOpen
